...
class MotionPlanner:
    ...
    def __init__(
        ...
        self.gripper_client2 = ActionClient(node, GripperCommand, '/fer_gripper/gripper_action')
    ...
    async def operate_gripper_3(self, position: float, max_effort: float):
        ...
        future = self.gripper_client2.send_goal_async(goal, feedback_callback=self.gripperFeedbackLogger)
        future.add_done_callback(self.goal_response_callback)
